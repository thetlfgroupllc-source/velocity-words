...
function VelocityWordsReader() {
    ...
    return (
        <div className="flex flex-col h-screen p-5 transition-all duration-300" style={{ background: currentTheme.bg, color: currentTheme.text }}>
            <div className="text-center py-8 mb-4">
                ...
                <p className="text-xs sm:text-sm transition-colors opacity-75" style={{ color: colorTheme === 'light' ? '#999' : '#888' }}>
                    📱 Swipe • ⌨️ Cmd+K • Space = Play
                </p>
            </div>
            ...
            <div className="flex-1 flex items-center justify-center relative min-h-[200px] sm:min-h-[300px] reading-area-swipe">
                {words.length === 0 ? (
                ...
                <div className="relative w-full max-w-[600px] h-[150px] sm:h-[200px] flex items-center justify-center px-4">
                    {/* Guide lines */}
                    {showGuideLines && (
                    ...
                    {/* Focus marker */}
                    <div className="absolute left-1/2 top-1/2 transform -translate-x-1/2 -translate-y-1/2 w-0.5 h-12 sm:h-16 pointer-events-none transition-opacity" 
                         style={{ backgroundColor: currentTheme.focusColor, opacity: focusLineOpacity / 100 }}></div>
                    
                    {/* Word display - focus letter ALWAYS aligned with center line */}
                    <div 
                        className="absolute top-1/2 font-medium z-10 whitespace-nowrap" 
                        style={{ 
            ...
            {showOnboarding && (
                <div 
                    ...
                    style={{ backgroundColor: 'rgba(0, 0, 0, 0.9)' }}
                >
                    <div className="max-w-md w-full rounded-2xl p-6" style={{ background: currentTheme.panel, border: `1px solid ${currentTheme.border}`, boxShadow: currentTheme.shadow, backdropFilter: "blur(10px)" }}>
                        {onboardingStep === 0 && (
                            <>
